...
> {
  ...
  async execute(
    command: GeneratePostImageUploadUrlCommand,
    ...
    // Reuse the generic response mappers
    return FileResponseMapper.toGenerateUploadUrlResponse(
      response,
    ) as GeneratePostImageUploadUrlResponseDto;
  }
}
