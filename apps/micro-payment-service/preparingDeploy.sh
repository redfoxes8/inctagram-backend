#!/bin/bash
sed -i -e "s/REGISTRY_HOSTNAME/$1/g"  ./apps/micro-payment-service/deployment.yaml
sed -i -e "s/PROJECT/$2/g" ./apps/micro-payment-service/deployment.yaml
sed -i -e "s/TAG_VERSION/$3/g" ./apps/micro-payment-service/deployment.yaml
